...
import { waLink } from "../data/courses";
...
export function WhatsAppFab({ message }: { message: string }) {
  return (
    <a className="wa-fab" href={waLink(message)} target="_blank" rel="noopener" aria-label="Falar no WhatsApp">
      <WaIcon />
